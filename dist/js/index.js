...
exports.default = {
	CoverSize: function CoverSize(imgWidth, imgHeight, containerWidth, containerHeight) {
		var originalRatios = {
	...
	IsInViewport: function IsInViewport(selector) {
	...
	IsCollide: function IsCollide(selector1, selector2) {
	...
	embedGenerate: function embedGenerate(url) {
